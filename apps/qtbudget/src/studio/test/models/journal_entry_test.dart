...
void main() {
  group('JournalEntry', () {
    ...
    test('amount returns inflow - outflow', () {
      expect(JournalEntry(id: 'e1', journalId: 'j1', description: 'a', inflow: 100, outflow: 30, date: now).amount, 70);
      expect(JournalEntry(id: 'e2', journalId: 'j1', description: 'a', inflow: 0, outflow: 50, date: now).amount, -50);
    });

    test('assert rejects negative values', () {
      expect(
        () => JournalEntry(id: 'e1', journalId: 'j1', description: 'a', inflow: -1, outflow: 0, date: now),
